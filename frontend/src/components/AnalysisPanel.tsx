    ...
    <div className="space-y-5 rounded-lg border bg-slate-50 p-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <p className="capitalize">{analysis.category}</p>
        </div>
      ...
      <div>
        ...
        <textarea
          rows={6}
          defaultValue={analysis.suggested_reply}
          className="mt-2 w-full rounded-md border bg-white p-3 focus:border-blue-500 focus:outline-none"
        />

        <button
          className="mt-3 rounded-lg bg-blue-600 px-4 py-2 font-medium text-white transition hover:bg-blue-700"
        >
          Send Reply
        </button>
      </div>
